...
export const IMAGE_MODELS: ImageModelDef[] = [
  ...
  // Ultra Mode: ControlNet models
  {
    id: 'flux-controlnet',
    name: 'FLUX ControlNet',
    replicateId: 'xlabs-ai/flux-controlnet',
    loraSupport: false,
    description: 'FLUX-based ControlNet for structure-aware generation from depth/pose/canny maps.',
    speed: 'medium',
    quality: 'high',
    costTier: '$$',
  },
  {
    ...
    loraSupport: false,
    description: 'FLUX Pro canny edge conditioning. Highest quality edge-guided generation.',
    speed: 'medium',
    quality: 'ultra',
    costTier: '$$$',
  },
  {
    ...
    loraSupport: false,
    description: 'FLUX Pro depth map conditioning. Best for preserving spatial structure.',
    speed: 'medium',
    quality: 'ultra',
    costTier: '$$$',
  },
  {
    id: 'controlnet-union-pro',
    name: 'ControlNet Union Pro',
    replicateId: 'briaai/controlnet-union-pro',
    loraSupport: false,
    description: 'Multi-control union model. Accepts depth, canny, pose simultaneously.',
    speed: 'medium',
    quality: 'high',
    costTier: '$$',
  },
  {
    id: 'sdxl-multi-controlnet',
    name: 'SDXL Multi-ControlNet',
    replicateId: 'fofr/sdxl-multi-controlnet-lora',
    loraSupport: true,
    loraParam: 'lora_weights',
    description: 'SDXL with multiple simultaneous ControlNet inputs plus LoRA support.',
    speed: 'slow',
    quality: 'high',
    costTier: '$$',
  },
  // Ultra Mode: Identity preservation
  {
    id: 'pulid-flux',
    name: 'PuLID FLUX',
    replicateId: 'zsxkib/pulid',
    loraSupport: false,
    description: 'PuLID face identity preservation on FLUX. Locks facial features across generations.',
    speed: 'medium',
    quality: 'ultra',
    costTier: '$$',
  },
...
export const VIDEO_MODELS: VideoModelDef[] = [
  ...
  // Ultra Mode: Structure-aware video models
  {
    id: 'vace-14b',
    name: 'WAN VACE 14B',
    replicateId: 'wan-video/wan-vace-14b',
    supportsImageToVideo: true,
    supportsReferenceImages: false,
    supportsAudio: false,
    maxDuration: 15,
    description: 'WAN VACE 14B structure-aware video. Conditioned on control maps for precise spatial control.',
    speed: 'slow',
    quality: 'ultra',
    costTier: '$$$',
    inputMapping: { startImage: 'image', prompt: 'prompt', duration: 'duration' },
  ...
  {
    id: 'ltx-2.3-pro',
    name: 'LTX Video 2.3 Pro',
    replicateId: 'lightricks/ltx-video-2.3-pro',
    supportsImageToVideo: true,
    supportsReferenceImages: false,
    supportsAudio: false,
    maxDuration: 10,
    description: 'LTX Video 2.3 Pro. Fast high-quality video with strong temporal coherence.',
    speed: 'fast',
    quality: 'high',
    costTier: '$$',
    inputMapping: { startImage: 'image', prompt: 'prompt', duration: 'duration' },
